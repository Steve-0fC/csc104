{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNor187RxfZmytZNkiTzkT0",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/JBattana/115-Assignments-OnCampus-/blob/main/Week1_Assignment_1_1.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        first_name = "Steven"
        last_name = "Clervil"
        message = greeting + " my name is " + first_name + last_name
        print("Q1 Greeting:", message)"
      ],
      "metadata": {
        "id": "Ept6SexKCEwQ"
      },
